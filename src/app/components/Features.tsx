...
function Features() {
  return (
    ...
    <div>
      <h1 className="text-lg pb-4 font-extrabold sm:text-xl md:text-2xl">Featured</h1>
      <img
        src="featured.jpg"
        alt="Featured"
        className="w-full h-auto object-cover max-w-md mx-auto sm:max-w-lg md:max-w-xl"
      />
    </div>
